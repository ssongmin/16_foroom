 ...
 */
public class Magazine_Item2_Fragment extends Fragment {


    public Magazine_Item2_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_magazine__item2_, container, false);

        ImageView res = (ImageView)v.findViewById(R.id.magazineImageItem2);
        MagazineFragment mf = new MagazineFragment();
        final MagazineValueObject mv = mf.magazineVO.get(1);
