 ...
 */
public class Magazine_Item3_Fragment extends Fragment {


    public Magazine_Item3_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_magazine__item3_, container, false);

        ImageView res = (ImageView)v.findViewById(R.id.magazineImageItem3);
        MagazineFragment mf = new MagazineFragment();
        final MagazineValueObject mv = mf.magazineVO.get(2);
